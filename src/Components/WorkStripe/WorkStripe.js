...
import SvgPattern from '../Backgrounds/SvgPattern';
...
const WorkStripe = React.forwardRef((props, ref) => {
  return (
    ...
    >
      ...
      {props.circleBg ? <SvgPattern /> : null}
